...
from .types.check_and_reserve_flag_response import CheckAndReserveFlagResponse
...
class RawFeaturesClient:
    ...
    def check_and_reserve_flag(
        ...
        *,
        ...
        user: typing.Optional[typing.Dict[str, str]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[CheckAndReserveFlagResponse]:
        """
        Parameters
        ----------
        key : str
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"flags/{encode_path_param(key)}/check-and-reserve",
            method="POST",
            json={
                "company": company,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=CheckAndReserveFlagResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawFeaturesClient:
    ...
    async def check_and_reserve_flag(
        self,
        key: str,
        *,
        company: typing.Optional[typing.Dict[str, str]] = OMIT,
        ...
        user: typing.Optional[typing.Dict[str, str]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CheckAndReserveFlagResponse]:
        """
        Parameters
        ----------
        key : str
