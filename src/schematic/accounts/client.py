...
class AccountsClient:
    ...
    def get_audit_log(
        self, audit_log_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> GetAuditLogResponse:
        """
        Parameters
        ----------
        ...
        """
        _response = self._raw_client.get_audit_log(audit_log_id, request_options=request_options)
        return _response.data
    ...
    def get_who_am_i(self, *, request_options: typing.Optional[RequestOptions] = None) -> GetWhoAmIResponse:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
        ...
        """
        _response = self._raw_client.get_who_am_i(request_options=request_options)
        return _response.data
...
class AsyncAccountsClient:
    ...
    async def list_audit_logs(
        ...
        *,
        ...
        async def main() -> None:
            await client.accounts.list_audit_logs(
                actor_type="api_key",
                end_time=datetime.datetime.fromisoformat(
                    "2024-01-15 09:30:00+00:00",
                ),
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.list_audit_logs(
            actor_type=actor_type,
            end_time=end_time,
            environment_id=environment_id,
            q=q,
    ...
    async def get_audit_log(
        ...
        async def main() -> None:
            await client.accounts.get_audit_log(
                audit_log_id="audit_log_id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.get_audit_log(audit_log_id, request_options=request_options)
        return _response.data
    ...
    async def count_audit_logs(
        ...
        *,
        ...
        async def main() -> None:
            await client.accounts.count_audit_logs(
                actor_type="api_key",
                end_time=datetime.datetime.fromisoformat(
                    "2024-01-15 09:30:00+00:00",
                ),
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.count_audit_logs(
            actor_type=actor_type,
            end_time=end_time,
            environment_id=environment_id,
            q=q,
    ...
    async def get_who_am_i(self, *, request_options: typing.Optional[RequestOptions] = None) -> GetWhoAmIResponse:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
        ...
        async def main() -> None:
            await client.accounts.get_who_am_i()


        asyncio.run(main())
        """
        _response = await self._raw_client.get_who_am_i(request_options=request_options)
        return _response.data
