...
class RawAccountsClient:
    ...
    ) -> HttpResponse[ListAccountMembersResponse]:
        """
        Parameters
        ----------
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ListAccountMembersResponse,  # type: ignore
    ...
    ) -> HttpResponse[GetAccountMemberResponse]:
        """
        Parameters
        ----------
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetAccountMemberResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ListAuditLogsResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    ) -> HttpResponse[GetAuditLogResponse]:
        """
        Parameters
        ----------
        audit_log_id : str
    ...
    def count_audit_logs(
        ...
        *,
        ...
        offset: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[CountAuditLogsResponse]:
        """
        Parameters
        ----------
        actor_type : typing.Optional[ActorType]
    ...
    def get_who_am_i(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[GetWhoAmIResponse]:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    GetWhoAmIResponse,
                    parse_obj_as(
                        type_=GetWhoAmIResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawAccountsClient:
    ...
    async def list_account_members(
        ...
        *,
        ...
        offset: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ListAccountMembersResponse]:
        """
        Parameters
        ----------
        ids : typing.Optional[typing.Union[str, typing.Sequence[str]]]
    ...
    async def get_account_member(
        self, account_member_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetAccountMemberResponse]:
        """
        Parameters
        ----------
        account_member_id : str
    ...
    async def list_audit_logs(
        ...
        *,
        ...
        offset: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ListAuditLogsResponse]:
        """
        Parameters
        ----------
        actor_type : typing.Optional[ActorType]
    ...
    async def get_audit_log(
        self, audit_log_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetAuditLogResponse]:
        """
        Parameters
        ----------
        audit_log_id : str
    ...
    async def count_audit_logs(
        ...
        *,
        ...
        offset: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CountAuditLogsResponse]:
        """
        Parameters
        ----------
        actor_type : typing.Optional[ActorType]
    ...
    async def get_who_am_i(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetWhoAmIResponse]:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
